...
### 1. `explorador-neurona.html` — Perceptrón ($\mathbb{R}^2 \to [0, 1]$)
...
### 2. `explorador-parametros.html` — Red 2→4→1 con capa homogénea
...
### 3. `explorador-activaciones.html` — Red 2→4→1 con activación por neurona
